...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Jun 2022 pada 03.54
...
(766600, 'dariroh', 'dairoh', '202cb962ac59075b964b07152d234b70', 1);
...
INSERT INTO `pembayaran` (`id_pembayaran`, `id_pesanan`, `bank_pemilik`, `no_rekening`, `nama_pemilik`) VALUES
(495097, 830201, 'mandiri', '022154682', 'DAIROH'),
(962193, 284085, 'bca', '123456', 'Mohammad Ali Vellayati Husaini');
...
--
ALTER TABLE `detail_pesanan`
  MODIFY `id_detail_pesanan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `status_pesanan`
  MODIFY `id_status_pesanan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
