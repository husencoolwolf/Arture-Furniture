...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Jul 2022 pada 01.05
...
(3, 765575, 'Zahra', 'jakarta timur', '', '', '454518432163'),
(4, 562875, 'Zahra', 'jakarta timur', '', '', '454518432163'),
(5, 289607, 'Zahra', 'jakarta timur', '', '', '454518432163'),
(6, 98909, 'dairoh', 'jakarta barat', '', 'ali.husen@gmail.com', '');
...
(175667, 98909, 'Lemari 1 Pintu', 1, '3x5m', 1200000),
...
(827565, 765575, 'Lampu taman', 4, 'Lampu Taman LED ', 1000000),
...
(98909, 'Beda Bulan', '2022-06-23 04:47:13', '2022-07-18 00:00:00', '2022-07-07 23:59:59'),
(161691, 'pengisian 1 rumah', '2022-07-12 16:50:03', '2022-07-01 00:00:00', '2022-07-31 23:59:59'),
(289607, 'pengisian taman', '2022-07-12 19:37:59', '2022-07-10 00:00:00', '2022-07-31 00:00:00'),
(562875, 'pengisian taman', '2022-07-12 19:34:38', '2022-07-10 00:00:00', '2022-07-31 00:00:00'),
(671278, 'pengisian taman', '2022-07-11 17:56:47', '2022-07-10 00:00:00', '2022-07-31 00:00:00'),
(765575, 'pengisian taman', '2022-07-12 19:22:31', '2022-07-10 00:00:00', '2022-07-31 00:00:00');
...
INSERT INTO `status_proyek` (`id_status_proyek`, `id_item_proyek`, `status`, `tanggal`, `keterangan`) VALUES
(1, 155758, 'menunggu hasil survey', '2022-07-11 17:56:47', '2 : 1'),
(2, 347682, 'menunggu hasil survey', '2022-07-11 17:56:48', '2 : 1'),
(3, 999227, 'menunggu hasil survey', '2022-07-12 16:50:03', '2 : 1'),
(4, 331682, 'menunggu hasil survey', '2022-07-12 16:50:03', '2 : 1'),
(5, 827565, 'selesai', '2022-07-12 19:22:32', '2 : 1'),
(6, 910740, 'menunggu hasil survey', '2022-07-12 19:34:38', '2 : 1'),
(7, 485385, 'menunggu hasil survey', '2022-07-12 19:37:59', '2 : 1'),
(8, 458280, 'menunggu hasil survey', '2022-07-12 19:37:59', '2 : 1'),
(12, 485385, 'menunggu konfirmasi dp', '2022-07-16 17:41:30', ''),
(13, 175667, 'batal', '2022-07-17 04:47:13', '2 : 1');
...
--
ALTER TABLE `detail_proyek`
  MODIFY `id_detail_proyek` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `status_pesanan`
  MODIFY `id_status_pesanan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT untuk tabel `status_proyek`
--
ALTER TABLE `status_proyek`
  MODIFY `id_status_proyek` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `detail_proyek`
  ADD CONSTRAINT `FK_detail_proyek_Proyek` FOREIGN KEY (`id_proyek`) REFERENCES `proyek` (`id_proyek`);

--
-- Ketidakleluasaan untuk tabel `item_proyek`
--
ALTER TABLE `item_proyek`
  ADD CONSTRAINT `ItemProyek_fk0` FOREIGN KEY (`id_proyek`) REFERENCES `proyek` (`id_proyek`);
...
--
ALTER TABLE `status_proyek`
  ADD CONSTRAINT `FK_item_proyek->status_proyek` FOREIGN KEY (`id_item_proyek`) REFERENCES `item_proyek` (`id_item_proyek`);
COMMIT;
