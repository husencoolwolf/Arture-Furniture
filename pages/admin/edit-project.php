<?php
$data = $db->getDataDetailProjectModalAdmin($_GET['project']);
...
<div class="container-fluid">
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      ...
      ?>
      <!--  -->
      <form id="formProject" action="/app/proses.php?aksi=edit-project-admin" method="post" enctype="multipart/form-data">
        <div class="form-group">
          <label for="inputNamaProject">Nama Proyek<span class="text-danger">*</span></label>
          <input class="form-control" type="text" name="inputNamaProject" id="inputNamaProject" value="<?= $dataProject['nama_proyek'] ?>" required>
        </div>
        <div class="form-group">
          <div class="row">
            <div class="col-6">
          ...
          <div class="row">
            <div class="col-6">
              <input class="form-control" type="date" name="inputDimulai" id="inputDimulai" value="<?= date('Y-m-d', strtotime($dataProject['dimulai'])) ?>" required>
            </div>
            <div class="col-6">
              <input class="form-control" type="date" name="inputSelesai" id="inputSelesai" value="<?= date('Y-m-d', strtotime($dataProject['target_selesai'])) ?>" required>
            </div>
          </div>
        </div>
        <div class="form-group">
          <label for="inputLokasi">Lokasi Proyek<span class="text-danger">*</span></label>
          <input class="form-control" type="text" name="inputLokasi" id="inputLokasi" value="<?= $dataProject['lokasi'] ?>" required>
        </div>
        <div class="form-group">
          <label for="inputAlamat">Alamat Proyek (Optional)</label>
          <textarea class="form-control" name="inputAlamat" id="inputAlamat" cols="30" rows="10"><?= $dataProject['alamat'] ?></textarea>
        </div>
        <div class="form-group">
          <label for="inputNama">Nama Klien<span class="text-danger">*</span></label>
          <input class="form-control" type="text" name="inputNama" id="inputNama" value="<?= $dataProject['nama_klien'] ?>" required>
        </div>
        <div class="form-group">
          <label for="inputEmail">Email Klien (Optional)</label>
          <input class="form-control" type="email" name="inputEmail" id="inputEmail" value="<?= $dataProject['email'] ?>">
        </div>
        <div class="form-group">
          <label for="inputNope">Nomor HP Klien (Optional)</label>
          <input class="form-control" type="text" name="inputNope" id="inputNope" value="<?= $dataProject['nomor_hp'] ?>">
        </div>
        ...
        <div class="border p-3 border-dark">
          ...
          <input type="submit" class="btn btn-primary mb-4 bottom" value="Edit Proyek">
        </div>
      </form>
    </main>
  </div>
