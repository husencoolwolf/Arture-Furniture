    ...
    <main role="main" class="col-md">
      ...
      <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="pembayaran" role="tabpanel" aria-labelledby="pembayaran-tab">
          <table class="table table-bordered table-warning table-hover table-responsive-md vh-80" id="tabelBelumbayar">
        ...
        <div class="tab-pane fade" id="dibuat" role="tabpanel" aria-labelledby="dibuat-tab">
          <table class="table table-bordered table-warning table-hover table-responsive-md vh-80" id="tabelDibuat">
            <thead class="bg-arture-emas" style="background-color: #ffd966;">
              <th>Gambar</th>
              <th>Nama Pesanan</th>
              <th>Jml Pesanan</th>
        ...
        <div class="tab-pane fade" id="dikirim" role="tabpanel" aria-labelledby="dikirim-tab">
          <table class="table table-bordered table-warning table-hover table-responsive-md vh-80" id="tabelDikirim">
            <thead class="bg-arture-emas" style="background-color: #ffd966;">
              <th>Gambar</th>
              <th>Nama Pesanan</th>
              <th>Jml Pesanan</th>
        ...
        <div class="tab-pane fade" id="selesai" role="tabpanel" aria-labelledby="selesai-tab">
          <table class="table table-bordered table-warning table-hover table-responsive-md vh-80" id="tabelSelesai">
            <thead class="bg-arture-emas" style="background-color: #ffd966;">
              <th>Gambar</th>
              <th>Nama Pesanan</th>
              <th>Jml Pesanan</th>
        ...
        <div class="tab-pane fade" id="batal" role="tabpanel" aria-labelledby="batal-tab">
          <table class="table table-bordered table-warning table-hover table-responsive-md vh-80" id="tabelBatal">
            <thead class="bg-arture-emas" style="background-color: #ffd966;">
              <th>Gambar</th>
              <th>Nama Pesanan</th>
              <th>Jml Pesanan</th>
