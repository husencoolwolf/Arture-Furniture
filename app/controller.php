...
class controller
{
    ...
    var $halamancss = array(
        ...
        array("dashboard", "tambah-produk", "edit-produk", "pesanan", "tambah-pesanan", "edit-pesanan")
    );
    ...
    var $halamanjs = array(
        ...
        array("dashboard", "produk", "tambah-produk", "edit-produk", "pesanan", "tambah-pesanan", "edit-pesanan")
    );
